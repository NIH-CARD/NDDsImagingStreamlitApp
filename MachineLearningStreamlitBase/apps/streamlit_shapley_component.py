...
def app():
    ...
    st.write(
        ...
        st.write(
            ...
            The X axis in the SHAP graph below corresponds to the SHAP value which can be positive or negative regarding the value of that feature in a patient. A vertical line mark the baseline SHAP value. While the Y axis in the graph correspond to the value of the feature.
